    ...
    <div className="bg-[#FFFBEF] text-[#0D0D0D] min-h-screen font-sans selection:bg-[#C6F94B]">
      ...
      <nav className="sticky top-0 z-50 bg-[#FFFBEF] border-b-2 border-black">
        <div className="max-w-6xl mx-auto px-5 md:px-8 h-16 flex items-center justify-between">
          <a
            href="#top"
            className="font-display text-xl font-black tracking-tight flex items-center gap-2"
          >
            <span className="inline-block w-3 h-3 bg-[#FF7A45] border-2 border-black rounded-sm" />
            vikas.dev
          </a>
          ...
          <button
            className="md:hidden border-2 border-black rounded-md px-3 py-1 text-sm font-bold"
        ...
        <div className="max-w-4xl mx-auto px-5 md:px-8 text-center">
          ...
          <div className="mt-12 grid sm:grid-cols-3 gap-5">
            ...
            >
              ...
              <span>WhatsApp</span>
              <span className="text-xs font-medium opacity-70">+91 89497 20403</span>
            </a>
            ...
            >
              ...
              <span>Email</span>
              <span className="text-xs font-medium opacity-70 break-all">v1241653@gmail.com</span>
            </a>
      ...
      <footer className="bg-[#0D0D0D] text-[#FFFBEF]/60 border-t-2 border-[#FFFBEF]/10">
        <div className="max-w-6xl mx-auto px-5 md:px-8 py-8 flex flex-wrap items-center justify-between gap-4 text-sm">
          <div>© {new Date().getFullYear()} Vikas — built with React, Tailwind & too much chai.</div>
